...
# GDS device types (shared with GSC, but some are GDS-only)
GDS_TRIGGER_TYPES = {
    "personnel_intrusion": "Intrusion/Loitering Alarm",
    "hostage": "Duress Alarm",
    "tamper": "Tamper Alarm",
    "keypad_error": "Keypad Multiple Input Errors Alarm",
    "remote_unlock_wrong_password": "Remote Unlock Wrong Password Alarm",
    ...
    "sd_card_unavailable": "SD Card Unavailable Alarm",
    "sd_card_formatted": "SD Card Formatted Alarm",
    "safe_room_alarm": "Safe Room Alarm",
    "door_close_timeout": "Door Close Timeout Alarm",
...
# GDS-only triggers (not available on GSC cameras)
# These triggers are specific to door access control features
...
GSC_TRIGGER_TYPES = {
    "power_insufficient": "Power Insufficient Alarm",
}
...
GDS_EVENT_MAPPING = {
    ...
    "di_2": "9",
    "di_3": "10",
    "sd_card_unavailable": "15",
    "sd_card_formatted": "16",
    "remote_unlock_wrong_password": "17",
    ...
    def _extract_index_from_unique_id(unique_id: str, pattern_type: str) -> int | None:
        ...
        try:
            ...
            if pattern_type == "fan_status" and "_status_" in unique_id:
                return int(unique_id.rsplit("_status_", maxsplit=1)[-1])
            ...
            return int(unique_id.rsplit("_", maxsplit=1)[-1])
        except (ValueError, IndexError) as _:
            return None
...
class AutomationTypeClassifier:
    ...
    def is_gds_event_trigger(cls, trigger_type: str) -> bool:
        ...
        return (
            trigger_type in GDS_EVENT_TRIGGERS or trigger_type in DOOR_ACCESS_TRIGGERS
        )
