...
- **GDS372X/GDS373X/GSC356X**: 实时状态监控、通话状态检测、设备控制、门锁功能
- **GNS5004E/GNS5004R**: 存储监控、系统性能监控、温度检测、设备控制

### 监控指标

- **GDS/GSC 设备**: 电话状态、可用账号、通话状态、振铃状态
- **GNS 设备**: CPU使用率、内存使用率、存储池状态、磁盘健康状态、网络流量、温度监控

### 设备控制

- **重启设备**: 支持GDS/GSC和GNS设备重启
- **电源管理**: GNS设备睡眠、唤醒、关机功能
- **摄像头支持**: GDS/GSC设备RTSP流媒体和快照功能
- **门锁控制**: GDS/GSC设备门锁开关操作
...
- `grandstream_home.unlock_door`: 解锁 GDS/GSC 设备的指定门锁
